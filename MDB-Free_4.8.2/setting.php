        ...
        ?> 
               ...
               <div class="d-flex justify-content-center">
                ...
                <div class="card" style=" margin-top: 100px; margin-bottom: 100px; width: 30%" style="background-image: url(ru.jpg); width: 28rem;">
                  ...
                  <h5 class="card-header light-gray black-text text-center py-4">
                ...
                <div class="md-form">
                      ...
                      <button class="btn btn-light btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" onclick="validate()">Change Password</button>
