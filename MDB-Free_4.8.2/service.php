    ...
    <div class="card-body col-mp-2">
      ...
      <!--Title-->
      <a href="upload.php"> <h4 class="card-title"<center>UPLOAD</center></h4>"</a>
      <!--Text-->
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <a href="newgrant.php"> <h4 class="card-title"<center>Grant</center></h4>"</a>
 ...
 <?php else :;?>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <a href="researches.php"> <h4 class="card-title"<center>Download</center></h4>"</a>
...
<div class="card-deck" style="margin-left: 300px; margin-right: 300px; margin-top: 20px; ">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <a href="researches.php"> <h4 class="card-title"<center>Search Any Paper</center></h4>"</a>
