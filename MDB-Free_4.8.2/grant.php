...
echo '
    ...
    <div class="media" style="margin-top:70px; margin-left: 400px; margin-right:400px; ">
  <img width="200" height="200" class="d-flex mr-3" src="'. $row[7].'" alt="Generic placeholder image">
  <div class="media-body p-2" style="margin-left:50px;">';
